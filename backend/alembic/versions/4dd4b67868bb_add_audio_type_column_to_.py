...
def upgrade() -> None:
    ...
    op.create_index(
        op.f('ix_action_items_created_at'),
        'action_items',
        ['created_at'],
        unique=False
    )
    ...
    op.create_index(
        op.f('ix_follow_up_questions_created_at'),
        'follow_up_questions',
        ['created_at'],
        unique=False
    )
    ...
    op.drop_constraint(
        'follow_up_questions_meeting_id_fkey',
        'follow_up_questions',
        type_='foreignkey'
    )
    ...
    # Add the missing audio_type column before creating its index.
    op.add_column(
        'transcript_segments',
        sa.Column(
            'audio_type',
    ...
    op.create_index(
        op.f('ix_transcript_segments_audio_type'),
        'transcript_segments',
        ['audio_type'],
        unique=False
    )
    ...
    op.create_index(
        op.f('ix_transcript_segments_timestamp'),
        'transcript_segments',
        ['timestamp'],
        unique=False
    )
...
def downgrade() -> None:
    ...
    # Remove the audio_type column when rolling back.
    op.drop_column(
        'transcript_segments',
        'audio_type'
    )
